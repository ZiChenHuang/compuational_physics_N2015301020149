...
Y1 = [math.sqrt(0.25-(x-0.5)**2) for x in X]
Y1[0], Y1[-1] = 0., 0.
...
anim = animation.FuncAnimation(fig, animate, frames=250, init_func=initAnimation, interval=0.1, blit=True)
#anim.save('hhh.gif', writer='imagemagick', fps=30, dpi=100)
pyplot.show()