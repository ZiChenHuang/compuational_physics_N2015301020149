...
plt.plot(x_j,y_j,color='green',linewidth=1)
plt.plot(x_s,y_s,color='red',linewidth=1)
plt.legend(('Earth','Jupiter','Sun'),'upper left')
plt.title('Three-body trajectory  Mass of Jupiter=1000$M_{j}$',fontsize=20)
plt.xlabel('x/AU')
plt.ylabel('y/AU')
#lt.xlim(-1,1)
#plt.ylim(-1,1)
#plt.scatter(x_j[-1],y_j[-1],t[-1],label="Jupiter",color="green")
...
ax.set_ylabel('y/AU')
ax.set_zlabel('t/yr')
ax.scatter(x_j[-1],y_j[-1],t[-1],label="Jupiter",color="green")
