...
bird_0_image = pygame.image.load("trump.png")
bird_1_image = pygame.image.load("trump.png")
bird_2_image = pygame.image.load("trump.png")
...
medals_0_image = pygame.image.load("kim.png")
medals_1_image = pygame.image.load("haha.png")
medals_2_image = pygame.image.load("kim.png")
medals_3_image = pygame.image.load("kim.png")
title_image = pygame.image.load("ft.png")
button_play_image = pygame.image.load("button_play.png")
ready_image = pygame.image.load("text_ready.png")
tutorial_image = pygame.image.load("angry_trump.png")
cd_image = pygame.image.load("cd.png")
...
def ready_page():
     ...
     while True:
          ...
          screen.blit(tutorial_image, (87, 195))
          screen.blit(cd_image, (35, 300))
...
def start_page(start_x, start_y, start_speed):
     ...
     pygame.mixer.music.load("LauraShigiharaWateryGraves.wav")  #加载并播放背景音乐，并且设置声音
...
def game_over_page(score, best, new):
     pygame.init()
     pygame.mixer.music.load("Donald Trump To Orlando Terrorist- 'Son Of A Bitch' 00_00_30-00_00_31.10.wav")  #加载并播放结束游戏音乐
     ...
     while True:
          ...
          if score < 1:
               ...
               screen.blit(medals_0_image, (50, 190))
          elif score >= 10 and score < 100:
               screen.blit(medals_1_image, (50, 190))
          elif score >= 100 and score < 500:
               screen.blit(medals_1_image, (50, 235))
          else:
               screen.blit(medals_0_image, (50, 235))
          if score < 10:
